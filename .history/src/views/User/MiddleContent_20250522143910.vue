    ...
    <div class="middle-body">
      <div class="file-upload">
        ...
        <div class="upload-module">
          <el-upload class="upload-box" drag :action="uploadUrl" :headers="uploadHeaders" :data="uploadParams"
            :on-success="handleUploadSuccess" :on-error="handleUploadError" :before-upload="beforeUpload"
            :on-progress="uploadProgress" accept=".zip,.rar,.doc,.docx,.md,.jpg,.png" multiple>
            <template #trigger>
