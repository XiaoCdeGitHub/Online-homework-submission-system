  ...
  <div class="admin-content-left">
    <div class="work-publish">
      ...
      <div class="file-upload-area">
        <el-upload class="homework-upload" drag action="#" :auto-upload="false" :on-change="handleFileChange" :limit="1"
          accept=".zip,.rar,.doc,.docx,.md,.jpg,.png" :show-file-list="true">
